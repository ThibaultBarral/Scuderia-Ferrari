...
<head>
    ...
    <title>Scuderia Ferrari - <?= (ucfirst(str_replace('-', ' ', $segments[1])) ? ucfirst(str_replace('-', ' ', $segments[1])) : 'Accueil') ?></title>
    ...
    <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css%22%3E">
</head>
<body>
